					...
					<tbody id="CTRL2">
						<xsl:for-each select="Tracking">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Date_x002F_Time', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Sim_No"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="Speed_x0028_km_x002F_h_x0029_"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Engine_state', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Acceleration', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Door', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
