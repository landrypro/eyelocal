				...
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>Num_portserial</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Path_database</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Last_latitude</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Last_longitude</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Path_logfile</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Parameters">
							...
							<tr>
								<td>
									<xsl:value-of select="Num_portserial"/>
								</td>
								<td>
									<xsl:value-of select="Path_database"/>
								</td>
								<td>
									<xsl:value-of select="Last_latitude"/>
								</td>
								<td>
									<xsl:value-of select="Last_longitude"/>
								</td>
								<td>
									<xsl:value-of select="Path_logfile"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
